...
namespace 草堂街道社会智能数据管理系统.dataClass
{
    /// <summary>
    ///   主要用于数据的基础操作 
    /// </summary>
    class DataBase
    {
        private readonly MySqlCommand m_Cmd;
        private readonly MySqlConnection m_Conn;
        ...
        public DataBase()
        {
            ...
            string strConn = "Database="+strDb+";Data Source=" + strServer + ";User Id=" + strUserID + ";Password=" + strPwd + ";charset='utf8';pooling=true";
            try
            {

...
namespace 草堂街道社会智能数据管理系统
{
    public partial class ListCtlFrom : Form
    {
        ...
        {
            laDwsjValue.Text = db.GetSingleObject("SELECT gridmanager.secretary FROM gridmanager WHERE gridmanager.id = '1'").ToString();
            laJwhzrValue.Text = db.GetSingleObject("SELECT gridmanager.director FROM gridmanager WHERE gridmanager.id = '1'").ToString();
            laDwsjTelValue.Text = db.GetSingleObject("SELECT gridmanager.secretary_code FROM gridmanager WHERE gridmanager.id = '1' ").ToString();
            laJwhzrTelValue.Text = db.GetSingleObject("SELECT gridmanager.director_code FROM gridmanager WHERE gridmanager.id = '1' ").ToString();
            laDwsjPhoneValue.Text = db.GetSingleObject("SELECT gridmanager.secretary_phone FROM gridmanager WHERE gridmanager.id = '1' ").ToString();
            laJwhzrPhoneValue.Text = db.GetSingleObject("SELECT gridmanager.director_phone FROM gridmanager WHERE gridmanager.id = '1' ").ToString();
